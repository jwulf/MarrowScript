/**
 * MarrowScript Admin Panel Emitter
...
export function emitAdminPanel(system: IR.IRSystem): string {
  ...
  return [
    ...
    '<meta name="marrowscript-api-url" content="http://localhost:3000" />',
    ...
    '<div class="p-6" id="content-area"><div class="text-center text-gray-400 mt-20"><div class="text-5xl mb-4">&#9889;</div><p class="text-lg">Select an entity from the sidebar</p><p class="text-sm mt-2">Generated by MarrowScript compiler</p></div></div>',
    '</main></div>',
...
(function() {
  "use strict";
  var BASE_URL = (document.querySelector('meta[name="marrowscript-api-url"]') || {}).content || "http://localhost:3000";
